...
# Split the data into training and testing sets - DO THIS ONLY ONCE
# This is the key fix - we split the data once and use same train/test for both models
...
# Using the SAME train/test split as the decision tree
...
# Compare accuracy of both models - this should now work correctly
...
2. Important Features: Both models identified Na_to_K ratio as the most influential factor 
   in determining drug classification, followed by BP and Age values.
...
3. Ensuring consistent train/test splits across different models for fair comparison.
